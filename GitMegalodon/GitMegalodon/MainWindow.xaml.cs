...
using Microsoft.WindowsAPICodePack.Dialogs; // You'll need to add NuGet package: Microsoft.WindowsAPICodePack-Shell
    ...
    public partial class MainWindow : Window
    {
        ...
        private async void Pull_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                await LoadCommitHistoryAsync();
                await LoadChangesAsync();
                MessageBox.Show($"Pull completed successfully.\n\n{output}", "Pull Successful", MessageBoxButton.OK, MessageBoxImage.Information);
            }
            catch (Exception ex)
            {
        ...
        private async void Push_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                MessageBox.Show($"Push completed successfully.\n\n{output}", "Push Successful", MessageBoxButton.OK, MessageBoxImage.Information);
            }
            catch (Exception ex)
            {
        ...
        private async void Fetch_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                await LoadBranchesAsync();
                MessageBox.Show("Fetch completed successfully.", "Fetch Successful", MessageBoxButton.OK, MessageBoxImage.Information);
            }
            catch (Exception ex)
            {
                MessageBox.Show($"Error during fetch: {ex.Message}", "Fetch Error", MessageBoxButton.OK, MessageBoxImage.Error);
            }
            finally
            {
                Mouse.OverrideCursor = null;
        ...
        private async void StageAll_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageBox.Show($"Error staging files: {ex.Message}", "Stage Error", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private async void UnstageAll_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageBox.Show($"Error unstaging files: {ex.Message}", "Unstage Error", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private async void UnstagedChangesList_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (UnstagedChangesList.SelectedItem is FileChange change)
            {
                ...
                {
                    // For untracked files, just show the file content if it's text
                    try
                    {
